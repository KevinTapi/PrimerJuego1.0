...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        platforms.create(400, 300, "ground").setScale(0.7).refreshBody();
        platforms.create(150, 150, "ground").setScale(0.2).refreshBody();
    ...
    addShape() {
        //get random shape
        const randomShape = Phaser.Math.RND.pick([DIAMOND, SQUARE, TRIANGLE, REDTRIANGLE, METEOR]);
